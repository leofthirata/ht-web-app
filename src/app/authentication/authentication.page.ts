...
export class AuthenticationPage implements OnInit {
  ...
  public async registerDevice() {
    ...
    // this.m_deviceTicket = dev.device_ticket;
  ...
  public async setTicket() {
    ...
    // this.pushToNextScreenWithParams('testing', {
    //   token: 
    //   myPubKey: this.m_auth.getPubKey(),
    //   myPrivKey: this.m_auth.getPrivKey(),
    //   devicePubKey: this.m_devicePublicKey,
    //   ip: this.m_ip,
    // });
    // this.pushToNextScreenWithParams('testing', this.m_ip);
    // this.pushToNextScreenWithParams('testing', this.m_ip);
    // this.pushToNextScreenWithParams('testing', this.m_ip);
  }
